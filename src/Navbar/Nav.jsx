...
const Nav = () => {
  ...
  <a className="navbar-brand">WebSite</a>
  ...
  <div className="collapse navbar-collapse" id="navbarSupportedContent">
    <ul className="navbar-nav mr-auto">
      ...
      <li className="nav-item active">
        <Link className="nav-link" to="/server">Servers<span className="sr-only">(current)</span></Link>
      </li>
      <li className="nav-item active">
        <Link className="nav-link" to="/countactus">Contact-Us<span className="sr-only">(current)</span></Link>
      </li>
    </ul>
